...
| Agentic Development | `spa/components/SpecAgentic.jsx` | `window.SpecAgentic` | `AgenticSignature` | `specializations[2]`, `id: "agentic"` |
...
| Agentic | the running artifact, and the `live` rail that points at it |
| CI/CD | see 7.1 |
| Governance | see 7.2 |
