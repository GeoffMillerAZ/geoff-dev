...
That asymmetry — invisible to users, visible in spend — is what makes the pattern durable. It doesn't require behavior change. It requires infrastructure that aligns cost with actual use.`,
  ...
  specializations: [
    ...
    },
    {
      ...
      placeholder: true,
      placeholderNote: "Every number on this page is a draft. The structural change is documented on the role; the timings attached to it have not been measured against a real delivery record.",
      proof: {
        rails: ["metrics", "roles", "testimony", "projects", "articles"],
        metrics: [
          {
    ...
    },
    {
      ...
      kicker: "The demo is the evidence",
      tone: "accent",
      icon: "sparkles",
      pageComponent: "SpecAgentic",
      tagline: "Agents that cannot fabricate. The interesting engineering is in what the model is structurally unable to do.",
      standfirst: "PLACEHOLDER STANDFIRST. The claim on this page is the hardest of the three to take on trust and the easiest to check, because the reader is already standing inside the artifact. Geoff to rewrite.",
      signature: {
        component: "AgenticSignature",
        title: "Where the model is, and where it is not",
        note: "PLACEHOLDER — the boundary shown is real and checkable in this page's own source.",
        source: "PLACEHOLDER DIAGRAM — illustrative. Draft pending Geoff's review. The retrieval boundary it draws is verifiable in spa/components/Recommendations.jsx.",
      },
      placeholder: true,
      placeholderNote: "Every number on this page is a draft. The mechanism is not: retrieval runs client-side in this browser and quoted text is rendered from stored records, which is checkable in the page source rather than taken on trust.",
      proof: {
        ...
        metrics: [
          {
            ...
            label: "Agentic systems running at PayPal",
            sub: "expert systems, incident tooling, GameDay scoring",
            placeholder: true,
            source: "PLACEHOLDER — draft figure. The systems are described on the PayPal role; the count and their production status have not been confirmed for publication.",
          },
          {
            id: "fabrication",
            value: "0", unit: "",
            label: "Model-authored attributed quotes",
            sub: "quotes are substring-checked in the browser before they render",
            placeholder: true,
            source: "PLACEHOLDER PRESENTATION of a real property — the substring gate is real and checkable in this repository, but presenting it as a measured metric is a draft framing Geoff should approve or cut.",
          },
          {
            id: "gates",
            value: "100", unit: "%",
            label: "Agent changes behind an approval gate",
            sub: "code, quality and intent review before merge",
            placeholder: true,
            source: "PLACEHOLDER — invented. The gates are claimed on the PayPal role; no coverage figure exists and this one should not be read as one.",
          },
        ...
        roles: [
          { roleId: "paypal", bulletTag: "ai",   match: "Lead and specialize in agentic software engineering",
            why: "Spec-driven development with automated review behind controlled approval gates." },
          { roleId: "paypal", bulletTag: "ai",   match: "Built the expert systems Command Center duty officers query",
            why: "Grounded in code, config, telemetry and playbooks — retrieval over a real corpus, under incident pressure." },
       ...
       there. A disclaimer implies a number is coming later; this one is not.  */
    {
      ...
      proof: {
        /* No `metrics` rail — see the note above the record. No `live` rail
           either: the running artifact belongs to Agentic Development, and a
       ...
       just as dishonest as a number with no source.                          */
    {
      ...
      standfirst: "PLACEHOLDER STANDFIRST. The work is turning a framework's prose into something that refuses a change at the moment it is made — and then being exact about how much of the framework that leaves untouched. The second half is the harder one, and it is why this page publishes its own gaps. Geoff to rewrite.",
      signature: {
      ...
      placeholderNote: "Not a draft: the four counts in the numbers rail. Each one was counted from the policy-pack repository and each names the tool run that checks it. A draft: the standfirst, the section prose and the labels inside the diagram, pending Geoff's review. And deliberately absent, in draft or otherwise, is any audit-reduction figure — no findings prevented, no controls inherited, no ATO duration, no audit hours saved. None of that is measured here, so none of it is published.",
      proof: {
        rails: ["metrics", "roles", "testimony", "projects", "articles"],
...
window.ORG_LOGOS = {
  "PayPal": {
    variants: [
      { kind: "wordmark", on: "light", file: "paypal-wordmark.svg" },
      { kind: "mono",     on: "dark",  file: "paypal-wordmark-reverse.svg" },
      { kind: "icon",     on: "any",   file: "paypal-icon.svg" },
    ],
  },

  "First Citizens Bank": {
    variants: [
      { kind: "wordmark", on: "light", file: "first-citizens-bank-wordmark.png" },
      { kind: "icon",     on: "any",   file: "first-citizens-bank-icon.png" },
    ],
  },
  ...
  "Silicon Valley Bank": {
    ...
    variants: [
      { kind: "wordmark", on: "light", file: "silicon-valley-bank-wordmark.svg" },
    ],
  },

  "REPAY": {
    variants: [
      { kind: "wordmark", on: "light", file: "repay-wordmark.png" },
    ],
  },
  ...
  "Early Warning Services": {
    ...
    variants: [
      { kind: "wordmark", on: "dark", file: "early-warning-services-wordmark-reverse.svg" },
    ],
  ...
  "Bank of America": {
    ...
    variants: [
      { kind: "wordmark", on: "light", file: "bank-of-america-wordmark.svg" },
      { kind: "icon",     on: "any",   file: "bank-of-america-icon.png" },
    ],
  },
  ...
  "Northern Illinois University": {
    ...
    variants: [
      { kind: "wordmark", on: "light", file: "northern-illinois-university-wordmark.png" },
      { kind: "mono",     on: "dark",  file: "northern-illinois-university-wordmark-reverse.svg" },
    ],
    alsoKnownAs: ["NIU"],
  },
  ...
  "Universal Technical Institute": {
    variants: [
      { kind: "wordmark", on: "light", file: "universal-technical-institute-wordmark.svg" },
    ],
    alsoKnownAs: ["UTI"],
  },
  ...
  "Geek Squad": {
    ...
    variants: [
      { kind: "wordmark", on: "any", file: "geek-squad-wordmark.svg" },
    ],
  },

  "Anthropic": {
    variants: [
      { kind: "wordmark", on: "light", file: "anthropic-wordmark.svg" },
      { kind: "mono",     on: "dark",  file: "anthropic-wordmark-reverse.svg" },
      { kind: "icon",     on: "light", file: "anthropic-icon.svg" },
      { kind: "icon",     on: "dark",  file: "anthropic-icon-reverse.svg" },
    ],
